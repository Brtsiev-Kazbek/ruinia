...
impl Solver {
    pub fn new(constraints: Vec<LocalMapChunk>, chunk_size: i32, map : &LocalMap) -> Solver {
        let chunks_x = (LOCAL_MAP_WIDTH / chunk_size) as usize;
        let chunks_y = (LOCAL_MAP_HEIGHT / chunk_size) as usize;
    ...
    pub fn iteration(&mut self, map: &mut LocalMap, rng : &mut super::RandomNumberGenerator) -> bool {
